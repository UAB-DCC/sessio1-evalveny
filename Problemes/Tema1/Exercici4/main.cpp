...
float testClasseLlibre()
{
	...
	cout << "Comment :=>>" << endl;
	cout << "Comment :=>> -----------------------------------------------" << endl;
	cout << "Comment :=>> Iniciant test del mètode presta" << endl;
	...
	cout << "Comment :=>>" << endl;
	cout << "Comment :=>> ----------------------------------------------------------------------" << endl;
	cout << "Comment :=>> Iniciant test del mètode retorna despres de fer els prestecs anteriors" << endl;
	cout << "Comment :=>> ----------------------------------------------------------------------" << endl;
	cout << "Comment :=>>" << endl;
	...
	cout << "Comment :=>>" << endl;
	cout << "Comment :=>> --------------------------------------------------------------------" << endl;
	cout << "Comment :=>> Iniciant test del mètode presta despres de fer els retorns anteriors" << endl;
	cout << "Comment :=>> --------------------------------------------------------------------" << endl;
	cout << "Comment :=>>" << endl;
...
float  testFuncionsLlibre()
{
	...
	{
		cout << "Comment :=>> llibre 1: " << titol[i] << ", " << autor[i] << ", " << nExemplars[i] << endl;
