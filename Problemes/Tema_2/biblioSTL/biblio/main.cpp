...
float testBiblio()
{
	...
	else
	{
		...
		if (!l.prestar("01/01/2017", codi))
		{
			cout << "Comment :=>> OK a PRESTAR: NO permet prestar llibre Thinking_in_C++ del qual ja no tenim exemplars sense prestar." << endl;
			punts += 0.35;
		}
		else
		{
		...
		cout << "Comment :=>>" << endl;
		cout << "Comment :=>> ---------------------------------------" << endl;
		cout << "Comment :=>> Afegir Exemplar a Thinking_in_C++(7):  " << endl;
		cout << "Comment :=>> ---------------------------------------" << endl;
		cout << "Comment :=>>" << endl;
		...
		if (!l.prestar("01/01/2017", codi))
		{
			cout << "Comment :=>> ERROR a PRESTAR O ADDEXEMPLAR: NO permet prestar llibre Thinking_in_C++ del qual tenim exemplars sense prestar (hem afegit un nou)." << endl;
		}
		else
		{
			cout << "Comment :=>> OK a PRESTAR I ADDEXEMPLAR: SI permet prestar llibre Thinking_in_C++ del qual tenim exemplars sense prestar (hem afegit un nou)." << endl;
			punts += 0.7;
