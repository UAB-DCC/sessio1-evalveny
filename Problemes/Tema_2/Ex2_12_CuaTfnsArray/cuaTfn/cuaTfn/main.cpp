...
float testSistemaTelfs()
{
	...
	cout << "Comment :=>>" << endl;
	cout << "Comment :=>> -------------------------------------------------" << endl;
	cout << "Comment :=>> Iniciant test Sistema Telefons: Afegint Telefons:" << endl;
	cout << "Comment :=>> -------------------------------------------------" << endl;
	cout << "Comment :=>>" << endl;
	...
	cout << "Comment :=>> NumTelefons: " <<numTelfs <<endl;
	...
	cout << "Comment :=>>" << endl;
	cout << "Comment :=>> -------------------------------------------------" << endl;
	cout << "Comment :=>> Iniciant test Sistema Telefons: Servint Telefons:" << endl;
	cout << "Comment :=>> -------------------------------------------------" << endl;
	cout << "Comment :=>>" << endl;
